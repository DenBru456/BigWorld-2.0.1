...
bwlog = __import__( "bin.%s.bwlog" % util.MF_CONFIG(), globals(), locals(), ['bwlog'] )
...
class lvSavedQuery( model.DictSQLObject ):
	...
	message = UnicodeCol( default="" )
	exclude = UnicodeCol( default="" )
	...
	class sqlmeta:
			createSQL = { 'mysql' : [
				"ALTER TABLE lv_saved_query CONVERT TO CHARACTER SET utf8" ]
				}
