	...
	<form action="javascript:staticFetch()" method="post" name="filters"
			...
			<td>
				...
				<span class="show">
					<input type="checkbox"
						name="show_host"
						id="show_host"
						title="Toggle whether the hostname is included in the output"/>
					<label for="show_host">Show</label>
				</span>
			</td>
			<td>
				<select name="host">
		...
		<tr>
			...
			<td>
				...
				<span class="show">
					<input type="checkbox"
						name="show_serveruser"
						id="show_serveruser"
						title="Toggle whether the username is included in the output"/>
					<label for="show_serveruser">Show</label>
				</span>
			</td>
			...
			<td>
				...
				<span class="show">
					<input type="checkbox"
						name="show_pid"
						id="show_pid"
						title="Toggle whether the PID is included in the output"/>
					<label for="show_pid">Show</label>
				</span>
			</td>
			<td>
			...
			<td>
				...
				<span class="show">
					<input type="checkbox"
						name="show_appid"
						id="show_appid"
						title="Toggle whether the App ID is included in the output"/>
					<label for="show_appid">Show</label>
				</span>
			</td>
			<td>
			...
			<td class="first">
				...
				<span class="show">
					<input type="checkbox"
						name="show_procs"
						id="show_procs"
						title="Toggle whether the process name is included in the output"/>
					<label for="show_procs">Show</label>
				</span>
			</td>
			<td>
				...
				<span class="show">
					<input type="checkbox"
						name="show_severity"
						id="show_severity"
						title="Toggle whether the message level is included in the output"/>
					<label for="show_severity">Show</label>
				</span>
			</td>
			<td>
		...
		<tr style="vertical-align: top">
			...
			<td>
				...
				<p style="font-weight: normal">
					...
					<label for="regex">Regex match</label>
					...
					<label for="interpolate">Pre-interpolate</label>
				</p>
			</td>
		</tr>
		</tbody>
		...
		<tr>
			<td colspan="2">
				...
				<span style="float: left">
					...
					<label for="autoHide">Auto-hide settings</label>
