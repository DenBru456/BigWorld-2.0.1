...
<head>
	...
	<script type="text/javascript" src="/static/js/menu_collapser.js"/>
...
<body>
		...
		<div py:if="not username" class="login">
			...
			<div>
				...
				<span id="loginbox">
					...
					<input type="submit" name="login_submit" value="Log In" class="login-button"/>
				</span>
			</div>
			</form>
		</div>

		<div py:if="username" id="menu_collapser" class="menu_collapser">
			<img src="/static/images/collapse_menu_normal.png"/>
		</div>
	</div>

	<table class="mainpanel" width="100%" cellspacing="0" cellpadding="0"
		   py:if="username or cherrypy.request.path == '/login'">

		<tr>
		<!-- Navigation panel on the left -->
		<td py:if="username" valign="top" class="spaced" id="navmenu_cell">
	...
	<div id="bad_browser" style="display: none;">
		...
		Recommended browser is <a href="http://www.firefox.com">
		Mozilla FireFox</a>
	</div>
