...
"""   Stop the specified processes gracefully.
   ...
   adversely effect the behaviour of an operational server. This option should
   be used preferentially to the 'killproc' and 'nukeproc' commands.
   ...
   See also: 'killproc' and 'nukeproc'"""
