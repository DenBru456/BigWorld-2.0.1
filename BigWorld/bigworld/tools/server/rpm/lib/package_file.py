...
class PackageFile( object ):
	...
	Generic file.
	"""
	def __init__( self, lineNum, source, destination, mode, owner, group ):
	...
	def clone( self, newClass=None ):
		...
		if newClass == None:
			newClass = PackageFile

		return newClass( self.lineNum, self.source, self.destination, 
...
class ConfigPackageFile( PackageFile ):
	...
	"""
	def __init__( self, lineNum, source, destination, mode, owner, group ):
		PackageFile.__init__( self, lineNum, source, destination, mode, owner, group )
