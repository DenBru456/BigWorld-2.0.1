	...
	uniform int nSpecularPoints )
{
	...
	o.diffuse = normalMapSpotDiffuse( worldPos, worldNormal, ambientColour, nSpot, nDir, nPoint, nDirBump, nPointBump );
	...
	uniform int nSpecularPoints )
{
	...
	BW_DEPTH(o.tcDepth.z, o.pos.z)
	BW_CALC_LIGHT_COUNTS_SPOT
	o.diffuse = normalMapSpotDiffuse( worldPos, worldNormal, i.diffuse, nSpot, nDir, nPoint, nDirBump, nPointBump );
