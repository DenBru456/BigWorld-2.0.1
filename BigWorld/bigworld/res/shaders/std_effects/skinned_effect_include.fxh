...
#define STATIC_LIGHTING_VERTEX_FORMAT			VertexXYZNUV2IIIWW_D
#define BUMPED_VERTEX_FORMAT					VertexXYZNUV2IIIWWTB
#define BUMPED_STATIC_LIGHTING_VERTEX_FORMAT	VertexXYZNUV2IIIWWTB_D

#elif VERTEX_COLOURS

#define VERTEX_FORMAT							VertexXYZNDUVIIIWW
#define STATIC_LIGHTING_VERTEX_FORMAT			VertexXYZNDUVIIIWW_D
#define BUMPED_VERTEX_FORMAT					VertexXYZNDUVIIIWWTB
#define BUMPED_STATIC_LIGHTING_VERTEX_FORMAT	VertexXYZNDUVIIIWWTB_D
