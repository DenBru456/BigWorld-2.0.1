...
#ifdef MOD2X
	o.diffuse = saturate(dot( lDir, i.normal )) * lightColour * 0.5 * (1 + diffuseLightExtraModulation) + selfIllumination;
#else
	o.diffuse = saturate(dot( lDir, i.normal )) * lightColour + selfIllumination;
#endif
	o.diffuse.w = 1;
	return o;
}
