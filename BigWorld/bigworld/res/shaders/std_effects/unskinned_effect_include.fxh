...
#define STATIC_LIGHTING_VERTEX_FORMAT			VertexXYZNUV2_D
#define BUMPED_VERTEX_FORMAT					VertexXYZNUV2TB
#define BUMPED_STATIC_LIGHTING_VERTEX_FORMAT	VertexXYZNUV2TB_D

#elif VERTEX_COLOURS

#define VERTEX_FORMAT							VertexXYZNDUV
#define STATIC_LIGHTING_VERTEX_FORMAT			VertexXYZNDUV_D
#define BUMPED_VERTEX_FORMAT					VertexXYZNDUVTB
#define BUMPED_STATIC_LIGHTING_VERTEX_FORMAT	VertexXYZNDUVTB_D
