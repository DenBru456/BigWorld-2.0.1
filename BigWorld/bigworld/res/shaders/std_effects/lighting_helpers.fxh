	...
	in int nPointBump )
{
	...
	if (nPoint > 0)
		diffuse.xyz += pointLight( pos, normal, pointLights[nPointBump] );
	if (nPoint > 1)
		diffuse.xyz += pointLight( pos, normal, pointLights[nPointBump + 1] );
	if (nPoint > 2)
		diffuse.xyz += pointLight( pos, normal, pointLights[nPointBump + 2] );
	if (nPoint > 3)
		diffuse.xyz += pointLight( pos, normal, pointLights[nPointBump + 3] );
