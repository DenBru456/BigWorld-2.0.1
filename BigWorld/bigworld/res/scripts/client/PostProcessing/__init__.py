...
def defaultChain( optionIdx = -1 ):
	...
	if optionIdx == 0:		#high
		chain( load( "High Graphics Setting.ppchain") )
	elif optionIdx == 1:	#medium
		chain( load( "Medium Graphics Setting.ppchain") )
	elif optionIdx == 2:	#low
		chain( load( "Low Graphics Setting.ppchain") )
	elif optionIdx == 3:	#none
		chain( None )
