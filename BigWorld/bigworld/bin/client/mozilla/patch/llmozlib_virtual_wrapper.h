...
class LLMozlibVirtualWrapper
{
	public:
		...
		virtual bool mouseDown( int browserWindowIdIn, int xPosIn, int yPosIn );		
		virtual bool mouseUp( int browserWindowIdIn, int xPosIn, int yPosIn );				
		virtual bool mouseMove( int browserWindowIdIn, int xPosIn, int yPosIn );			
		virtual bool mouseLeftDoubleClick( int browserWindowIdIn, int xPosIn, int yPosIn );	
		virtual bool keyPress( int browserWindowIdIn, int keyCodeIn );						
		virtual bool unicodeInput ( int browserWindowIdIn, unsigned long uni_char );		
