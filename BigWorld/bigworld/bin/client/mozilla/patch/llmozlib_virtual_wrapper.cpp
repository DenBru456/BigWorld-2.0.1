...
bool LLMozlibVirtualWrapper::mouseDown( int browserWindowIdIn, int xPosIn, int yPosIn )	       
{
  return llmozlib->mouseDown(browserWindowIdIn, xPosIn, yPosIn );	      
}

bool LLMozlibVirtualWrapper::mouseUp( int browserWindowIdIn, int xPosIn, int yPosIn )			       
{
  return llmozlib->mouseUp( browserWindowIdIn, xPosIn, yPosIn );			      
}

bool LLMozlibVirtualWrapper::mouseMove( int browserWindowIdIn, int xPosIn, int yPosIn )		       
{
  return llmozlib->mouseMove( browserWindowIdIn, xPosIn, yPosIn );		      
}

bool LLMozlibVirtualWrapper::mouseLeftDoubleClick( int browserWindowIdIn, int xPosIn, int yPosIn )  
{
  return llmozlib->mouseLeftDoubleClick( browserWindowIdIn, xPosIn, yPosIn ); 
}
...
bool LLMozlibVirtualWrapper::unicodeInput ( int browserWindowIdIn, unsigned long uni_char )	       
{
  return llmozlib->unicodeInput ( browserWindowIdIn, uni_char );	      
}
