...
FDGUI_COMPONENTS = (
	...
	# Note better keep action bar last as it uses the windows already defined before it
...
class FDGUI( BWKeyBindings.BWActionHandler ):
	...
	def setupGUI( self, actionToolTipsSection, keyBindings ):
		...
		self.webWindow.script.setRatePerSecond(10)
	...
	def targetFocus( self, entity ):
		...
		try:
			overheadText = entity.name()
		except:
			try:
				overheadText = entity.__class__.__name__
			except:
				overheadText = ""
