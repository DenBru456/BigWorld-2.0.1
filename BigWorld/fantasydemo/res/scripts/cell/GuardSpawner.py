...
class GuardSpawner( BigWorld.Entity ):
	...
	def spawnGuardsLocally( self, sourceID, numberOfGuards, maxGuards, spawnDuration ):
		self.base.spawnGuardsLocally( self.base, numberOfGuards, maxGuards, spawnDuration, self.guardTimeToLive )
